<template>
  <div class="bg-white py-20">
    <div class="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
      <div class="mx-auto max-w-2xl lg:text-center flex flex-col items-center justify-center">
        <h2 class="text-base/7 font-semibold text-blue-600 text-center">Deploy faster</h2>
        <p
          class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance text-center"
        >
